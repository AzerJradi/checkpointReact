    ...
    <div className="carddsss">
      ...
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
          Created as a high-powered vehicle based on the Audi A7 Sportback and S7 Sportback, the RS 7 debuted for the 2014 model year.  <br/> <br />
          </Card.Text>
        </Card.Body>
        <ListGroup className="list-group-flush">
      ...
      <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
          The C6 RS 6 Avant was launched in April 2008, and the four-door saloon/sedan was available from August 2008. <br /><br /><br />
          </Card.Text>
        </Card.Body>
        <ListGroup className="list-group-flush">
